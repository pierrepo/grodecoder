...
`DNA_map_jump.pdb`, `DNA_map_reor.pdb`, `RNA_map_jump.pdb` and `RNA_map_reor.pdb`
- molecular inventory: 
    - residues 1 to 18 from GCGGGGGGGGGGGGGGGC
    - residues 19 to 36 from GCCCCCCCCCCCCCCCGC
- resolution: all-atom
- source: Zenodo [dataset](https://zenodo.org/records/10647894), file `DNA_map_jump.pdb`, `DNA_map_reor.pdb`, `RNA_map_jump.pdb` and `RNA_map_reor.pdb`
...
- molecular inventory: 
    ...
    - 88 chloride ions
    - 122 potassium ions
    - 31 683 water molecules (TIP3P)
- resolution: all-atom
- source: Zenodo [dataset](https://zenodo.org/records/10647894), file `DNA_start.gro`
...
- molecular inventory: 
    ...
    - 122 potassium ions
- resolution: all-atom
- source: Zenodo [dataset](https://zenodo.org/records/10647894), file `DNA_start_nowat.gro`
...
- molecular inventory: 
    ...
    - 110 potassium ions
- resolution: all-atom
- source: Zenodo [dataset](https://zenodo.org/records/10647894), file `RNA_start_nowat.gro`